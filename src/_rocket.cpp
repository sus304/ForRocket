...
void ForRocket::Rocket::dynamics_6dof_ballistic(const state& x, const double t)
{
    
}

void ForRocket::Rocket::dynamics_3dof_parachute(const state_parachute& x, const double t)
{

}

void ForRocket::Rocket::operator()(const state& x, state& dx, const double t)
{

}

void ForRocket::RocketObserver::operator()(const state& x, double t)
{
