...
def run(config_file):
    ...
    json_obj = json.load(config)
    config.close()
    print('Config File: ', config_file)

    # Make Result Directory
    model_name = json_obj.get('System').get('Name')
    ...
    rocket = Simulator.Rocket(json_obj)
    ...
    if single_condition:
        ...
        launch_site = LaunchSiteProvider.LaunchSite(launch_site_name)
